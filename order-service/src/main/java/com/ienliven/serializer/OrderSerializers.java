...
public class OrderSerializers {
    // implements Serializer {
    /*
     * @Override public byte[] serialize(String s, Object order) { byte[] retVal =
     * null; ObjectMapper objectMapper = new ObjectMapper(); try { retVal =
     * objectMapper.writeValueAsString(order).getBytes(); } catch (Exception e) {
